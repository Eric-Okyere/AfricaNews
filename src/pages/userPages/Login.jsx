...
const Login = () => {
  return (
    <div className='w-full flex h-[70vh] justify-center items-center'>
      <div className='bg-blue-500 p-6 mt-20 rounded-lg  flex flex-col justify-center
        items-center  space-y-4 w-[80%] md:w-[25%]'>
        <h1 className='text-2xl font-bold text-left'>Login into your accont</h1>
            <input className='w-full outline-0 px-4 py-2 rounded-lg' type='text' placeholder='Enter your email'/>
            ...
            rounded-lg hover:bg-slate-600 hover:text-black '>
                ...
                <div className='hover:text-slate-600'>
                    <Link className='font-bold flex' to={"/register"}>New here? <p className='ml-10 text-white hover:text-black'>Register</p></Link>
                </div>
            </div>
    </div>
  )
